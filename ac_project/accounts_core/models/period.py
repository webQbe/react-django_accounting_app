...
class Period(models.Model):  # Each Period represents a time bucket
    # during which financial transactions are grouped

    # Every company has its own independent calendar of periods
    company = models.ForeignKey(
        Company,
        # Prevent accidental deletion of periods
        # tied to journal entries, invoices, or bills
    ...
    """ When is_closed=True:
            ...
            that could corrupt finalized reports.
    """
    ...
    class Meta:
        ...
        # periods are returned sorted by company, then chronologically
